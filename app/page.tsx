        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
            <div className="text-center bg-white/80 backdrop-blur-sm border border-white/40 rounded-2xl p-8 shadow-md">
              ...
              <h3 className="text-lg font-bold text-slate-800 mb-2">Expert Guides</h3>
            ...
            <div className="text-center bg-white/80 backdrop-blur-sm border border-white/40 rounded-2xl p-8 shadow-md">
              ...
              <h3 className="text-lg font-bold text-slate-800 mb-2">Actionable Tips</h3>
              <p className="text-sm text-slate-800 leading-relaxed">
            ...
            <div className="text-center bg-white/80 backdrop-blur-sm border border-white/40 rounded-2xl p-8 shadow-md">
              ...
              <h3 className="text-lg font-bold text-slate-800 mb-2">No Jargon</h3>
              <p className="text-sm text-slate-800 leading-relaxed">
              ...
              <div className="flex items-start gap-5">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest text-gold bg-gold/20 px-2.5 py-1 rounded-full">
                      New
                    </span>
                  </div>
